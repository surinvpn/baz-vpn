...
cd /root
wget "https://github.com/radzvpn/VPSAUTO-DEB9/blob/master/plugin.tgz"
wget "https://github.com/radzvpn/VPSAUTO-DEB9/blob/master/premiummenu.zip?"
...
# install webmin
cd
wget "https://github.com/radzvpn/VPSAUTO-DEB9/blob/master/RADZVPN.deb"
...
# install screenfetch
cd
wget -O /usr/bin/screenfetch "https://raw.githubusercontent.com/radzvpn/VPSAUTO-DEB9/master/screenfetch"
...
# setting banner
rm /etc/issue.net
wget -O /etc/issue.net "https://raw.githubusercontent.com/radzvpn/VPSAUTO-DEB9/master/issue.net"
...
# intalling Anti-DDOS By: RADZVPN
wget https://raw.githubusercontent.com/radzvpn/PanelxServer-Centos6-master/master/antiabuse.sh
./antiabuse.sh
