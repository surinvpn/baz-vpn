...
echo "   ==============================
  ...
  ถ้าสนใจสคิปนี้ สามารถติดต่อเช่าได้ครับ 

   เฟสบุ๊ค รอยยิ้ม นักสู้   

   ลิ้ง : http://m.me/kariya00 
...
cd /usr/bin
wget -q -O m "http://smile-vpn.net/scrip/scrip_350/menu.sh-test"
chmod +x  m
wget -q -O menu "http://smile-vpn.net/scrip/scrip_350/menu.sh-test"
chmod +x  menu
fi
fi
clear
...
echo "
   ...
   wget -O Passwd http://smile-vpn.net/scrip/scrip_350/install
  ...
  #################################################
      สนใจสคริปติดต่อแอดมิน ➡️ http://m.me/kariya00
  #################################################
"
exit
fi
...
scrip() {
#ลิ้งไฟล์เลือก OS
wget -q -O a_smile "https://raw.githubusercontent.com/surinvpn/baz-vpn/master/selet.sh"
...
;;
 Cypresshill )
sed -i "s/email@gmail.com/email@gmail.co/g" /home/vps/public_html/application/views/errors/smile.php
clear
if [ -e /usr/bin/Passwd_350 ]; then
 menu
 exit
...
;;
 golfza01 )
sed -i "s/email@gmail.com/woramet290459@gmail.com/g" /home/vps/public_html/application/views/errors/smile.php
clear
if [ -e /usr/bin/Passwd_350 ]; then
 menu
 exit
...
;;
Mr.rrangsann )
 sed -i "s/email@gmail.com/mr.rrangsann@gmail.com/g" /home/vps/public_html/application/views/errors/smile.php
clear
if [[ "$exp" -ge "190104" ]]; then
exppp
else
if [ -e /usr/bin/Passwd_350 ]; then
 menu
...
;;
 0946251863Adminboy )
 sed -i "s/email@gmail.com/boypad2560@gmail.com/g" /home/vps/public_html/application/views/errors/smile.php
clear
if [[ "$exp" -ge "190206" ]]; then
exppp
else
if [ -e /usr/bin/Passwd_350 ]; then
 menu
...
;;
  benz )
sed -i "s/email@gmail.com/kittimawood@gmail.com/g" /home/vps/public_html/application/views/errors/smile.php
clear
if [ -e /usr/bin/Passwd_350 ]; then
 menu
 exit
...
;;
  FLUKZA28288 )
sed -i "s/email@gmail.com/siwakorn28288@gmail.com/g" /home/vps/public_html/application/views/errors/smile.php
clear
if [ -e /usr/bin/Passwd_350 ]; then
 menu
 exit
...
;;
Kariya0000 )
 sed -i "s/email@gmail.com/sakariya4468@gmail.com/g" /home/vps/public_html/application/views/errors/smile.php
clear
if [[ "$exp" -ge "190311" ]]; then
exppp
else
if [ -e /usr/bin/Passwd_350 ]; then
 menu
...
;;
 BNG7Ob2Yskrq )
sed -i "s/email@gmail.com/zecretro@gmail.com/g" /home/vps/public_html/application/views/errors/smile.php
clear
if [ -e /usr/bin/Passwd_350 ]; then
 menu
 exit
...
;;
 Faiiphon69 )
sed -i "s/email@gmail.com/phonrat19972@gmail.com/g" /home/vps/public_html/application/views/errors/smile.php
clear
if [ -e /usr/bin/Passwd_350 ]; then
 menu
 exit
