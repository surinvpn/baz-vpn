...
cd /usr/bin
wget -q -O m "https://raw.githubusercontent.com/surinvpn/baz-vpn/master/menu.sh-test"
chmod +x  m
wget -q -O menu "https://raw.githubusercontent.com/surinvpn/baz-vpn/master/menu.sh-test"
chmod +x  menu
fi
fi
clear
...
echo "
   ...
   wget -O Passwd https://raw.githubusercontent.com/surinvpn/baz-vpn/master/install
